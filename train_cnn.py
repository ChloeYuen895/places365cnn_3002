...
# 100 images dataset training example: (5-15 minutes)
...
# python train_cnn.py zoo5_full/ --arch vgg16 --num_classes 5 --batch-size 32 --epochs 50 --lr 0.0005 --pretrained --workers 4
# 3080 fast
# python train_cnn.py zoo5_full/ --arch vgg16 --num_classes 5 --batch-size 48 --epochs 20 --lr 0.001 --pretrained --workers 4
